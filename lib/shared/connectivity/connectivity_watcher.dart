...
class ConnectivityNotifier extends StateNotifier<ConnectivityState> {
  ...
  void _updateState(
    ...
    _print('🔌 Has connection: $hasConnection');
    ...
    if (state.status != newStatus) {
      ...
      _print(
        '🔌 State updated: ${state.status.displayName} (simulated: $isSimulated)',
      );
    }
  }
  ...
  void simulateOnline() {
    ...
    _print('🎭 Simulating ONLINE state');
  }
  ...
  void simulateOffline() {
    ...
    _print('🎭 Simulating OFFLINE state');
  }
  ...
  ConnectivityResult? _getPrimaryConnectivityType(
    List<ConnectivityResult> results,
  ) {
...
/// ------------------------------------------------------
/// CONNECTIVITY WATCHER WIDGET - FIXED STACK ISSUE
/// ------------------------------------------------------
...
class _ConnectivityWatcherState extends ConsumerState<ConnectivityWatcher>
  ...
  void _handleConnectivityChange(ConnectivityState state) {
    _print('🔄 Handling connectivity change: ${state.status.displayName}');
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        // Connectivity banner - FIXED: No Material wrapper around Positioned
        if (isBannerVisible)
          Positioned(
            top: 0,
            left: 0,
            right: 0,
            child: _bannerView(bannerConfig),
          ),
      ],
    );
  }

  Material _bannerView(BannerConfig bannerConfig) {
    return Material(
      elevation: 0,
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          return Transform.translate(
            offset: Offset(
              0,
              widget.showTransitionAnimations ? _slideAnimation.value : 0.0,
            ),
            child: Opacity(
...
class _ConnectivityBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      // Material goes here, not around Positioned
      elevation: 0,
      color: Colors.transparent,
      child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _DebugInfoRow(
                ...
                color: connectivityState.isSimulated
                    ? Colors.orange
                    : Colors.grey,
              ),
              _DebugInfoRow(
